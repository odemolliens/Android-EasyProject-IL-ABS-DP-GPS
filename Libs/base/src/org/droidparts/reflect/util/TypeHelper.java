...
public final class TypeHelper {
	...
	public static Object parseValue(Class<?> valCls, String valStr)
		...
		if (isByte(valCls)) {
			...
			Date dateObj = null;
			try {
				dateObj = SimpleDateFormatFactory.getInstance().getFormatter()
						.parse(String.valueOf(valStr));
			} catch (Exception e) {
				e.printStackTrace();
			}
			return dateObj;
	...
	public static class SimpleDateFormatFactory {
		private static SimpleDateFormatFactory instance = new SimpleDateFormatFactory();
		...
		public static SimpleDateFormatFactory getInstance() {
			return instance;
		}
